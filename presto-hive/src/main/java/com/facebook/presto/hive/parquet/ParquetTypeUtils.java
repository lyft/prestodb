...
public final class ParquetTypeUtils
{
    ...
    public static Type getPrestoType(RichColumnDescriptor descriptor, HiveType hiveType, TypeManager typeManager)
    {
        switch (descriptor.getType()) {
            case BOOLEAN:
                return BooleanType.BOOLEAN;
            case BINARY:
                return createDecimalType(descriptor).orElse(createVarcharType(hiveType, typeManager));
            case FLOAT:
    ...
    private static Type createVarcharType(HiveType hiveType, TypeManager typeManager)
    {
